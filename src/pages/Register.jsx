...
const Register = () => {
const {emailPasswordRegister,updateUser} = useAuth()
...
<p className='text-sm text-black'>“Great platform for manage school library and control the access of books"</p>
        ...
        <div className='w-[70%] mx-auto flex flex-col items-center gap-5'>
          ...
          >
            ...
            <p className='text-center text-gray-600'>Register to Bookify and find your library management solution</p>
            ...
            <input type="email" required name="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg   focus:border-orange-400 focus:ring-orange-300  focus:outline-none focus:ring focus:ring-opacity-40" placeholder='Enter Email Address'/>
        </div>
        <div className='mt-6'>
