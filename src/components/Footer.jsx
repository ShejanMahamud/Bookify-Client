...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-5 space-y-2">
              <a href="#" className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-primary hover:underline hover:text-primary">Translation</a>
              <a href="#" className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-primary hover:underline hover:text-primary">Proofreading & Editing</a>
              <a href="#" className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-primary hover:underline hover:text-primary">Content Creation</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-5 space-y-2">
              <a href="#" className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-primary hover:underline hover:text-primary">+880 768 473 4978</a>
              <a href="#" className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-primary hover:underline hover:text-primary">info@merakiui.com</a>
            </div>
          </div>
        </div>
      ...
      w-10'/>
      <span className='text-2xl font-medium font-briem-hand text-gray-800 dark:text-white'>Bookify</span>
    </div>
